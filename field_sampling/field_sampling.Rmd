...
1. Individual Summary Table for your class data
2. Boxplot of Sunny diversity data (created in Step 5d)
3. Boxplot of Shady diversity data
4. Summary of diversity differences

**Part 2. Homework**

1. Summary Table for State biome data
2. Boxplot of biome data
3. Boxplot of biome data for 3 states
